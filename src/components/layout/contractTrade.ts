 ...
 * @LastEditors: 田鑫
 * @LastEditTime: 2024-07-22 16:55:19
 * @Description:
 */
...
export const contractTradeLayout: ScreenResolutionMap[] = [
	{
		...
		resolution: {
			...
			"[1024, 1280]": [
				...
				{ width: [266, 266], compName: "ExchangeInfo", height: 1147, x: 0, y: 64, zIndex: "1", fixed: true, show: true },
				{ width: [760, 1010], compName: "UserExchangeTable", height: 684, x: 268, y: 527, zIndex: "1", fixed: true, show: true },
			],
			"[1281, 1440]": [
				...
				{ width: [265, 298], compName: "ExchangeInfo", height: 1147, x: [1015, 1142], y: 64, zIndex: "1", fixed: false, show: true, minW: 4, minHeight: 43 },
				{ width: [1013, 1140], compName: "UserExchangeTable", height: 535, x: 0, y: 676, zIndex: "1", fixed: false, show: true, minW: 10, minHeight: 40 },
			],
			"[1441, 1920]": [
				...
				{ width: [298, 318], compName: "ExchangeInfo", height: 1147, x: [1142, 1601], y: 64, zIndex: "1", fixed: false, show: true, minW: 3, minHeight: 43 },
				{ width: [1140, 1600], compName: "UserExchangeTable", height: 535, x: 0, y: 676, zIndex: "1", fixed: false, show: true, minW: 7, minHeight: 40 },
			],
			"[1921, 2560]": [
				...
				{ width: [318, 425], compName: "ExchangeInfo", height: 1147, x: [1601, 2135], y: 64, zIndex: "1", fixed: false, show: true, minW: 3, minHeight: 43 },
				{ width: [1600, 2133], compName: "UserExchangeTable", height: 535, x: 0, y: 676, zIndex: "1", fixed: false, show: true, minW: 7, minHeight: 40 },
			],
			"[2561, 3840]": [
				...
				{ width: [425, 638], compName: "ExchangeInfo", height: 1859, x: [2135, 3202], y: 64, zIndex: "1", fixed: false, show: true, minW: 2, minHeight: 43 },
				{ width: [2133, 3200], compName: "UserExchangeTable", height: 1244, x: 0, y: 677, zIndex: "1", fixed: false, show: true, minW: 7, minHeight: 40 },
			],
		},
	},
	{
		...
		resolution: {
			"[768, 1023]": [
				{ width: [768, 1023], compName: "Header", height: 60, x: 0, y: 2, zIndex: "2", fixed: true, show: true },
				{ width: [498, 753], compName: "ExchangeChart", height: 550, x: 268, y: 64, zIndex: "1", fixed: true, show: true },
				{ width: [498, 753], compName: "ExchangeList", height: 306, x: 266, y: 617, zIndex: "1", fixed: true, show: true },
				{ width: [266, 266], compName: "ExchangeInfo", height: 859, x: 0, y: 64, zIndex: "1", fixed: true, show: true },
				{ width: [768, 1023], compName: "UserExchangeTable", height: 356, x: 0, y: 925, zIndex: "1", fixed: true, show: true },
			],
			"[1024, 1280]": [
				{ width: [1024, 1280], compName: "Header", height: 60, x: 0, y: 2, zIndex: "2", fixed: true, show: true },
				...
				{ width: [254, 265], compName: "ExchangeInfo", height: 1147, x: 0, y: 64, zIndex: "1", fixed: true, show: true },
				{ width: [768, 1013], compName: "UserExchangeTable", height: 535, x: [256, 267], y: 676, zIndex: "1", fixed: true, show: true },
			],
			"[1281, 1440]": [
				{ width: [1281, 1440], compName: "Header", height: 60, x: 0, y: 2, zIndex: "2", fixed: true, show: true },
				...
				{ width: [265, 298], compName: "ExchangeInfo", height: 1147, x: 0, y: 64, zIndex: "1", fixed: false, show: true, minW: 4, minHeight: 43 },
				{ width: [1013, 1140], compName: "UserExchangeTable", height: 535, x: [267, 300], y: 676, zIndex: "1", fixed: false, show: true, minW: 10, minHeight: 40 },
			],
			"[1441, 1920]": [
				{ width: [1441, 1920], compName: "Header", height: 60, x: 0, y: 2, zIndex: "2", fixed: true, show: true },
				...
				{ width: [298, 318], compName: "ExchangeInfo", height: 1147, x: 0, y: 64, zIndex: "1", fixed: false, show: true, minW: 3, minHeight: 43 },
				{ width: [1140, 1600], compName: "UserExchangeTable", height: 535, x: [300, 320], y: 676, zIndex: "1", fixed: false, show: true, minW: 7, minHeight: 40 },
			],
			"[1921, 2560]": [
				{ width: [1921, 2560], compName: "Header", height: 60, x: 0, y: 2, zIndex: "2", fixed: true, show: true },
				...
				{ width: [318, 425], compName: "ExchangeInfo", height: 1147, x: 0, y: 64, zIndex: "1", fixed: false, show: true, minW: 2, minHeight: 43 },
				{ width: [1600, 2133], compName: "UserExchangeTable", height: 535, x: [320, 427], y: 676, zIndex: "1", fixed: false, show: true, minW: 7, minHeight: 40 },
			],
			"[2561, 3840]": [
				{ width: [2561, 3840], compName: "Header", height: 60, x: 0, y: 2, zIndex: "2", fixed: true, show: true },
				...
				{ width: [425, 638], compName: "ExchangeInfo", height: 1859, x: 0, y: 64, zIndex: "1", fixed: false, show: true, minW: 2, minHeight: 43 },
				{ width: [2133, 3200], compName: "UserExchangeTable", height: 1244, x: [427, 640], y: 674, zIndex: "1", fixed: false, show: true, minW: 7, minHeight: 40 },
			],
		},
	},
];
